...
function checkAudits(dailyAudits, dailyHours, currentAudits, hoursWorked) {
  ...
  document.getElementById('results2').textContent = `Daily Audits: ${dailyAudits} | Daily Hours: ${dailyHours} | Current Audits: ${currentAudits} | Hours Worked: ${hoursWorked} | Hourly Audits Goal: ${auditsPerHour}`;
}